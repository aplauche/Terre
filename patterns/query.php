...
<!-- wp:group {"layout":{"type":"flex"},"style":{"spacing":{"blockGap":"5px","margin":{"bottom":"30px"}}},"fontSize":"x-small"} -->
<div class="wp-block-group has-x-small-font-size" style="margin-bottom:30px">
<!-- wp:post-date /-->
<!-- wp:paragraph -->
<p>·</p>
<!-- /wp:paragraph -->
